...
# Load necessary libs
for (v in names(ToothGrowth)) {
  print(unique(ToothGrowth[, v]))
}
```

```{r data.exp.vs, echo=TRUE}
# Take a look at the data
ggplot(ToothGrowth, aes(x=factor(dose, levels = c(0.5, 1.0, 2.0)), y=len, group=factor(dose, levels = c(0.5, 1.0, 2.0)))) + 
...
### Hypothesis 3: dose = 0.5 and does = 2 have different distributions of tooth length
...
### Hypothesis 4: dose = 1 and does = 2 have different distributions of tooth length
