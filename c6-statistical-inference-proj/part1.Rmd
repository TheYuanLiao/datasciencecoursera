...
Calculate the sample variance and theoretical variance.
...
## Conclusions
Given the assumption that the sample represents the population, the results confirms the Central Limit Theorem.